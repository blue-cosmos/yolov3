...
def get_class_names(class_name_file):
    with open(class_name_file, 'r', encoding='utf-8') as fin:
        lines = fin.readlines()
    return [line for line in lines if line.strip()]

def load_network(config_file, class_name_file, weights, batch_size=1):
    """
    ...
    class_names = get_class_names(class_name_file)
